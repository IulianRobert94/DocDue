...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  en: {
    ...
    privacy_permissions_body: "The app requests access to camera and photo library only to attach documents. Face ID / fingerprint is used only for app unlock. No access to location or contacts is requested. The only internet connection is for in-app purchases through RevenueCat, which receives only anonymous transaction data (transaction ID, product purchased, platform). Details: https://www.revenuecat.com/privacy.",
